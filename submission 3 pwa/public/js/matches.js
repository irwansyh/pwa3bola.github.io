        ...
        if (dataMatch[i].matchday === matchDays.filter(unique)[idx]) {
            tableDataMatches += `
                <tr>
                    ...
                    <td> <a href="./detailMatch.html?id=${dataMatch[i].id}">Detail</a> </td>
                </tr>
            `;
        } else {
            tableMatchesHtml += `
...
function getResultMatchDetailJSON(data) {
    ...
    tableMatchDetailHtml += `
        ...
        <div class="row">
            <div class="col s5 m5 l5 center-align"> <h5> <a href="./detailTeam.html?id=${match.homeTeam.id}">${match.homeTeam.name}</a> </h5> </div>
            <div class="col s2 m2 l2 center-align"> <h5> - </h5> </div>
            <div class="col s5 m5 l5 center-align"> <h5> <a href="./detailTeam.html?id=${match.awayTeam.id}">${match.awayTeam.name}</a> </h5> </div>
        </div>
